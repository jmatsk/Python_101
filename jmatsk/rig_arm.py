...
# (nevermind, disregard) add enum attr to fkik switch for keyable switch value
### cmds.addAttr('fkik_switch_ctrl', longName='FK_IK_Switch', attributeType='enum', enumName='FK:IK', keyable=True)
